...
Future<int> bottomSheet(BuildContext context, patList) async {
  ...
  Widget _sheetWidget(context, patList, userInfo) {
                      ...
                      children: <Widget>[
                        Wrap(
                          ...
                          children: <Widget>[
                            ...
                            Icon(Icons.person, color: userInfo["Patient"]["Sex"] == 1
                                ? Colors.blue
                                : Colors.pinkAccent),
                            Text('6岁'),
                            Text('(当前患者)',
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Expanded(
                    child: Wrap(
                      alignment: WrapAlignment.center,
                      children: <Widget>[Icon(Icons.folder_open, color: Colors.yellow), Text('临时听诊', style: TextStyle(color: Colors.yellow))],
                    ),
                  ),
                ],
              ),
